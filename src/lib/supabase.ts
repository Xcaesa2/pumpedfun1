...
if (!supabaseUrl || !supabaseAnonKey || 
  ...
  throw new Error(`
    ...
    2. Replacing the placeholder values with your actual Supabase credentials:
       - VITE_SUPABASE_URL=https://azrrbhiafveiobbncoon.supabase.co
       - VITE_SUPABASE_ANON_KEY=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImF6cnJiaGlhZnZlaW9iYm5jb29uIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTAwMzc4MjAsImV4cCI6MjA2NTYxMzgyMH0.0hjyrLjFEd5-hK5w_5qYtAsOs5IoJb23ktk3XiffTQk
    ...
    Current values:
    - VITE_SUPABASE_URL: ${supabaseUrl || 'https://azrrbhiafveiobbncoon.supabase.co'}
    - VITE_SUPABASE_ANON_KEY: ${supabaseAnonKey ? '[SET]' : 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImF6cnJiaGlhZnZlaW9iYm5jb29uIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTAwMzc4MjAsImV4cCI6MjA2NTYxMzgyMH0.0hjyrLjFEd5-hK5w_5qYtAsOs5IoJb23ktk3XiffTQk'}
  `)
}
...
try {
  ...
  throw new Error(`
    ...
    Please ensure your VITE_SUPABASE_URL is a valid URL (e.g., https://azrrbhiafveiobbncoon.supabase.co)
  `)
}
